              ...
              {freePointers.map((p, k) => {
                return (
                  <li key={k} className='mt-2'>
                    <CheckIcon className='w-4 h-4 text-green-500 inline-block' /> {p}
                  </li>
                )
              })}
            </ul>
        ...
        <div className='card w-full mt-6  bg-base-100 shadow-xl hover:shadow-2xl'>
          <div className='card-body pt-12 pb-16 items-center  '>
            ...
            <h2 className='font-bold mt-4 text-4xl text-center inline-block'>
              {toggleActive ? `$5` : `$8`}{' '}
              {toggleActive && (
                <span className='text-xl line-through text-secondary align-middle mr-2'>$8</span>
              )}
              <span className='text-xs align-middle font-light text-slate-500'>/monthly</span>
            </h2>
            <button
        ...
        <div className='card w-full mt-6  bg-base-100 shadow-xl hover:shadow-2xl'>
          <div className='card-body pt-12 pb-16 items-center  '>
            ...
            <h2 className='font-bold mt-4 text-4xl text-center inline-block'>
              {toggleActive ? `$12` : `$15`}{' '}
              {toggleActive && (
                <span className='text-xl line-through text-secondary align-middle mr-2'>$15</span>
              )}
              <span className='text-xs align-middle font-light text-slate-500'>/monthly</span>
            </h2>
            <button
